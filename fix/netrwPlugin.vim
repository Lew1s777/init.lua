"Path /usr/share/nvim/runtime/plugin/netrwPlugin.vim
...
" Maps:
if !exists("g:netrw_nodx")
 if maparg('dx','n') == ""
  if !hasmapto('<Plug>NetrwBrowseX')
   nmap <unique> dx <Plug>NetrwBrowseX
  endif
  nno <silent> <Plug>NetrwBrowseX :call netrw#BrowseX(netrw#DX(),netrw#CheckIfRemote(netrw#DX()))<cr>
 endif
 if maparg('dx','x') == ""
  if !hasmapto('<Plug>NetrwBrowseXVis')
   xmap <unique> dx <Plug>NetrwBrowseXVis
  endif
