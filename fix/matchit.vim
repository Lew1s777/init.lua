"Path /usr/share/nvim/runtime/pack/dist/opt/matchit/plugin/matchit.vim
...
if !exists("g:no_plugin_maps")
  ...
  nmap <silent> d% <Plug>(MatchitNormalBackward)
  xmap <silent> %  <Plug>(MatchitVisualForward)
  xmap <silent> d% <Plug>(MatchitVisualBackward)
  omap <silent> %  <Plug>(MatchitOperationForward)
  omap <silent> d% <Plug>(MatchitOperationBackward)
